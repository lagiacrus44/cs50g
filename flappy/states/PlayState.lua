...
function PlayState:init()
    ...
    self.pipePairs = {}
    self.timer = 0
    self.spawnInterval = math.random(2,3) -- spawn interval randomized from 1 to 3
    self.score = 0
...
function PlayState:update(dt)
    ...
    if self.timer > self.spawnInterval then
        ...
        -- randomize the spawn interval again, only after a pipe pair has been drawn for the previous interval
